...
//        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        a.setQtde(Integer.parseInt(request.getParameter("qtde")));
        a.setPrecoCompra(Double.parseDouble(request.getParameter("precoCompra")));
        a.setPrecoVenda(Double.parseDouble(request.getParameter("precoVenda")));
        a.setLucro(Double.parseDouble(request.getParameter("lucro")));
